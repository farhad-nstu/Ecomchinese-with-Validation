...
<div class="nk-sidebar nk-sidebar-fixed is-dark " data-content="sidebarMenu">
          ...
          {{-- <h6 class="nk-menu-text">@lang('messages.change_language')</h6>
                    <div class="form-control-wrap">
                        <select class="form-select changeLang">
                             <option value="en" {{ session()->get('locale') == 'en' ? 'selected' : '' }}>@lang('messages.english')
          </option>
  ...
  <li class="nk-menu-item has-sub">
    ...
    <ul class="nk-menu-sub">
      ...
      <li class="nk-menu-item">
        <a href="{{ url('/categories/create') }}" class="nk-menu-link"><span class="nk-menu-text">Add
            Category</span></a>
      </li>
      <li class="nk-menu-item">
        <a href="{{ route('categories.index') }}" class="nk-menu-link"><span class="nk-menu-text">Category
            List</span></a>
      </li>
    ...
    <ul class="nk-menu-sub">
      ...
      <li class="nk-menu-item">
        <a href="{{ url('/subcategories/create') }}" class="nk-menu-link"><span class="nk-menu-text">Add Sub
            Category</span></a>
      </li>
      <li class="nk-menu-item">
        <a href="{{ route('subcategories.index') }}" class="nk-menu-link"><span class="nk-menu-text">Sub Category
            List</span></a>
      </li>
  ...
  <li class="nk-menu-item has-sub">
    ...
    <ul class="nk-menu-sub">
      ...
      <li class="nk-menu-item">
        <a href="{{ url('/brands/create') }}" class="nk-menu-link"><span class="nk-menu-text">Add Brand</span></a>
      </li>
      <li class="nk-menu-item">
        <a href="{{ route('brands.index') }}" class="nk-menu-link"><span class="nk-menu-text">Brand List</span></a>
      </li>
  ...
  <li class="nk-menu-item has-sub">
    ...
    <ul class="nk-menu-sub">
      ...
      <li class="nk-menu-item">
        <a href="{{ url('/sliders/create') }}" class="nk-menu-link"><span class="nk-menu-text">Add Slider</span></a>
      </li>
      <li class="nk-menu-item">
        <a href="{{ route('sliders.index') }}" class="nk-menu-link"><span class="nk-menu-text">Slider List</span></a>
      </li>
