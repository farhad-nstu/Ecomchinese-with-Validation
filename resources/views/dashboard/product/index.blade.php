        ...
        <div class="nk-block-head nk-block-head-sm">
          <div class="nk-block-between">
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title">Brands List</h3>
                ...
                <div class="toggle-expand-content" data-content="pageMenu">
                  <ul class="nk-block-tools g-3">
                    <li class="nk-block-tools-opt">
                      <a href="{{ route('products.create') }}" class=" btn btn-icon btn-primary"><em
              ...
              <div class="card-inner p-0">
                <div class="nk-tb-list nk-tb-ulist">
                  <div class="nk-tb-item nk-tb-head">
                    ...
                    <div class="nk-tb-col tb-col-mb"><span class="sub-text">Brand</span></div>
                    <div class="nk-tb-col tb-col-mb"><span class="sub-text">Quantity</span></div>
                  ...
                  <div class="nk-tb-item">
                    ...
                    <?php $images = App\Models\Image::where('product_id',
                                                $product->id)->get(); ?>
                    <div class="nk-tb-col">
                      <a href="html/user-details-regular.html">
                        <div class="user-card">
                          <div class="user-info">
                            @if ($images)
                            <span class="tb-lead"><img src="{{ $images[0]->image }}" width="100px;"><span
                    ...
                    <div class="nk-tb-col">
                      <a href="html/user-details-regular.html">
                        <div class="user-card">
                          ...
                          <div class="user-info">
                            <span class="tb-lead">{{ $product->quantity }}<span
                                class="dot dot-success d-md-none ml-1"></span></span>
                          </div>
                        </div>
                      </a>
                    ...
                    <div class="nk-tb-col tb-col-md">
                      <a class="btn btn-sm btn-success" href="{{ route('products.edit', $product->id) }}" title="Edit">
