        ...
        <div class="nk-block-head nk-block-head-sm">
          <div class="nk-block-between">
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title">Slider List</h3>
                ...
                <div class="toggle-expand-content" data-content="pageMenu">
                  <ul class="nk-block-tools g-3">
                    <li class="nk-block-tools-opt">
                      <a href="{{route('sliders.create')}}" class=" btn btn-icon btn-primary"><em
                ...
                <div class="nk-tb-list nk-tb-ulist">
                  ...
                  <div class="nk-tb-item">
                      ...
                      <a href="html/user-details-regular.html">
                        <div class="user-card">
                          <div class="user-info">
                            ...
                            <span class="tb-lead"><img src="{{ $slider->image }}" width="100px;"><span
                    ...
                    <div class="nk-tb-col tb-col-md">
                      ...
                      <form id="delete-form-{{ $slider->id }}" action="{{ route('sliders.destroy',$slider->id) }}"
