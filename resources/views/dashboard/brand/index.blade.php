                ...
                <div class="toggle-expand-content" data-content="pageMenu">
                  <ul class="nk-block-tools g-3">
                    <li class="nk-block-tools-opt">
                      <a href="{{route('brands.create')}}" class=" btn btn-icon btn-primary"><em
                ...
                <div class="nk-tb-list nk-tb-ulist">
                  ...
                  <div class="nk-tb-item">
                    ...
                    <div class="nk-tb-col tb-col-md">
                      <a class="btn btn-sm btn-success" href="{{route('brands.edit', $brand->id)}}" title="Edit">
                      ...
                      <form id="delete-form-{{ $brand->id }}" action="{{ route('brands.destroy',$brand->id) }}"
